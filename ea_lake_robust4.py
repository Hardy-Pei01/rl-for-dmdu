    ...
    for random_seed in [
        ...
        for r_metric in ["10th", "avg"]:
            ...
            ea_robust_training4(nfe=nfe, random_seed=random_seed, scenario_num=25,
                                model=create_lake4_deep_training,
                                problem=lake4_uncertain_problem,
                                scenario_path='./results/lake_scenarios/train_scenarios.csv',
                                restore_path=None, borg=False, n_processes=75,
                                results_path=f'./results/ea_lake_robust_42/{r_metric}_{nfe//10000}_{random_seed}{current_time_ea}',
                                checkpoint_path=f'./tmp/ea_lake_robust_42/{r_metric}_{nfe//10000}_{random_seed}{current_time_ea}',
