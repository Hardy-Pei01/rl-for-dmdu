...
for r_metric in ["10th", "avg"]:
    ...
    # for random_seed in [1926216712]:
        ...
        scenarios = pd.read_csv("./results/lake_scenarios/train_scenarios_rl_prev.csv")
        ...
        mdp = MOMDP(problem, seed=random_seed, utopia=utopia, antiutopia=antiutopia, dstate=3, dreward=2)
        robj = 1
