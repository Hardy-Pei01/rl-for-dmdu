'''
This module provides functionality for combining the EMAWorkbench workbench
...
class EngingeLoggerAdapter(logging.LoggerAdapter):
    '''LoggerAdapter that inserts EMAWorkbench as a topic into log messages
...
def set_engine_logger():
    '''Updates EMAWorkbench logging on the engines with an EngineLoggerAdapter
    This adapter injects EMAWorkbench as a topic into all messages
    '''
