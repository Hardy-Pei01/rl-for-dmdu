...
Exceptions and warning used internally by the EMAWorkbench workbench. In line with
...
class EMAWarning(EMAError):
    '''
    base EMAWorkbench warning class
    '''
    pass
