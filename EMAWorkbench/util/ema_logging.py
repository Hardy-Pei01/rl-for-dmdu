...
This module contains code for logging EMAWorkbench processes. It is modeled on the
...
def temporary_filter(name=LOGGER_NAME, level=0, functname=None):
    ...
    (e.g. EMAWorkbench.analysis.prim)
...
def get_rootlogger():
    '''
    Returns root logger used by the EMAWorkbench workbench

    Returns
    -------
    the logger of the EMAWorkbench workbench
