...
This file illustrated the use the EMAWorkbench classes for a contrived vensim
example
...
from EMAWorkbench import (TimeSeriesOutcome, perform_experiments,
                           RealParameter, ema_logging)

from EMAWorkbench.connectors.vensim import VensimModel
