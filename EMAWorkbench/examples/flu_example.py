...
from EMAWorkbench import (Model, RealParameter, TimeSeriesOutcome,
                           perform_experiments, ema_logging)

from EMAWorkbench.analysis import lines, Density
from EMAWorkbench import MultiprocessingEvaluator
...
def flu_model(
    ...
    for time in range(int(INITIAL_TIME / TIME_STEP),
