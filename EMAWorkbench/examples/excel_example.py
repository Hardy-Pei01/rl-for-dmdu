...
This file illustrated the use the EMAWorkbench classes for a model in Excel.
...
'''
from EMAWorkbench import (RealParameter, TimeSeriesOutcome, ema_logging,
                           perform_experiments)

from EMAWorkbench.connectors.excel import ExcelModel
from EMAWorkbench.em_framework.evaluators import MultiprocessingEvaluator
