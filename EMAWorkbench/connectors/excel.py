...
This module provides a base class that can be used to perform EMAWorkbench on
...
class BaseExcelModel(FileModel):
    ...
    Base class for connecting the EMAWorkbench workbench to models in Excel. To
