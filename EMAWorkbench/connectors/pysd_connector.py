...
from EMAWorkbench.util.ema_logging import method_logger
from EMAWorkbench.em_framework.model import SingleReplication
...
class BasePysdModel(AbstractModel):
    ...
    def run_experiment(self, experiment):
        ...
        # EMAWorkbench wants output formatted properly
