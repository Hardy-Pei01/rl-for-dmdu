...
for r_metric in ["avg"]:
    ...
    for random_seed in [
                        ...
                        # 1350287007, 674137616,
                        # 3624030427, 703574460,
                        # 1883682950, 617160326,
                        3668976038, 96930842
    ]:
        ...
        checkpoint_path = f"./results/rl_lake_robust_43/{method}_{r_metric}_{random_seed}_{N}_{MAXITER}_0{int(epsilon*10)}_{current_time}"
        start = datetime.now()
