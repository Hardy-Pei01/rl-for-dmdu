...
if __name__ == "__main__":
    ...
    for random_seed in [3186775264, 3690172787, 462638671, 1926216712, 3087161096,
        ...
        ea_training(nfe=nfe, random_seed=random_seed,
                    model=create_lake_discrete_training,
                    problem=lake_problem,
                    restore_path=None, borg=False, n_processes=75,
                    results_path=f'./results/ea_lake_1/discrete_{nfe//10000}_{random_seed}{current_time_ea}',
                    checkpoint_path=f'./tmp/ea_lake_1/discrete_{nfe//10000}_{random_seed}{current_time_ea}.pickle')
