...
from utils.ea.create_models import create_fishing3_training
...
if __name__ == "__main__":
    for random_seed in [1]:
        ...
        ea_training(nfe=2000000, random_seed=random_seed,
                    model=create_fishing3_training,
                    problem=fishing_problem,
                    borg=False, n_processes=75,
                    results_path=f'./results/ea_fishing/3_200_{random_seed}{current_time_ea}',
                    restore_path=None, checkpoint_path=f'./tmp/ea_fishing/3_{random_seed}{current_time_ea}.pickle')
