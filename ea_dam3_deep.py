...
if __name__ == "__main__":
    for random_seed in [1]:
        ...
        ea_robust_training(nfe=2000000, random_seed=random_seed, scenario_num=50,
                           model=create_dam3_deep_training,
                           ...
                           results_path=f'./results/ea_dam_deep/3_avg_200_{random_seed}{current_time_ea}',
                           checkpoint_path=f'./tmp/ea_dam_deep/3_avg_200_{random_seed}{current_time_ea}.pickle',
                           r_metric="avg")
